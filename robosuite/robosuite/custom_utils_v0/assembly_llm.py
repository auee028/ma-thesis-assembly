...
class AssemblyLLM:
    ...
    def _get_prompt_files(self):
        ...
        prompt_files["example_prompts"] = self.llm_config.get("prompt_txt_files").get("example_prompts")
    ...
    def _build_messages(self):
        ...
        examples = self._process_examples(
            ...
            read_file(self.prompt_files["example_prompts"])
        )
    ...
    def run_llm(self):
        ...
        """
        # Init model
        llm_provider = self.llm_config.get("model_config").get("provider")
        llm_model = self.llm_config.get("model_config").get("model")
