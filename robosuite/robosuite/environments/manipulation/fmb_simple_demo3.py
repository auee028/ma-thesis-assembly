...
class AssemblySimpleDemo3(ManipulationEnv):
    """
    ...
    def _load_model(self):
        ...
        self.obj1 = FMBObject(
            name="obj1",	# frame
            fmb_xml_file="custom_objects/fmb/meshes/simple_demo3/obj1/obj1.xml",
        )
        self.obj2 = FMBObject(
            name="obj2",	# U-shaped block
            fmb_xml_file="custom_objects/fmb/meshes/simple_demo3/obj2/obj2.xml",
        )
        self.obj3 = FMBObject(
            name="obj3",	# long cuboid
            fmb_xml_file="custom_objects/fmb/meshes/simple_demo3/obj3/obj3.xml",
        )
    ...
    def _reset_internal(self):
        ...
        placements = {
            ...
            self.obj3: [0.12, 0.08, self.table_offset[2] + 0.01], # [0.1, -0.15, self.table_offset[2] -0.005] (before recentering .obj file)
        }
