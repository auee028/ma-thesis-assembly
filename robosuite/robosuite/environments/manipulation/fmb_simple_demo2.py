...
class AssemblySimpleDemo2(ManipulationEnv):
    """
    ...
    def _load_model(self):
        ...
        self.obj1 = FMBObject(
            name="obj1",	# frame
            fmb_xml_file="custom_objects/fmb/meshes/simple_demo2/obj1/obj1.xml",
        )
        self.obj2 = FMBObject(
            name="obj2",	# long cuboid
            fmb_xml_file="custom_objects/fmb/meshes/simple_demo2/obj2/obj2.xml",
        )
        self.obj3 = FMBObject(
            name="obj3",	# stepped block
            fmb_xml_file="custom_objects/fmb/meshes/simple_demo2/obj3/obj3.xml",
        )
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [obj1_pos, obj1_quat, obj2_pos, obj2_quat, obj3_pos, obj3_quat]
    ...
    def _reset_internal(self):
        ...
        placements = {
            ...
            self.obj2: [0.12, -0.12, self.table_offset[2] + 0.01], # [0.1, -0.3, self.table_offset[2] -0.005] (before recentering .obj file)
            self.obj3: [0.12, 0.13, self.table_offset[2] + 0.045], # [0.1, -0.15, self.table_offset[2] -0.005] (before recentering .obj file)
        }
