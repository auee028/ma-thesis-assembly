...
class Pyramid(ManipulationEnv):
    """
    This class corresponds to the customized Pyramid task for a single robot arm.
    ...
    def staged_rewards(self, action=None):
        ...
        higher_one = [offset - higher_layer_offset for offset in sorted_offsets[2:]]
        ...
        reward = sum(scaled_r_lower + scaled_r_higher)
    ...
    def _load_model(self):
        ...
        self.blocks = [self.cubeA, self.cubeB, self.cubeC]
