...
env = suite.make(
    ...
    # camera_depths=['frontview', 'birdview', 'agentview', 'robot0_robotview', 'robot0_eye_in_hand'],
    camera_names=['frontview', 'birdview', 'agentview'],
    camera_depths=['frontview', 'birdview', 'agentview'],
...
save_dir = f'/home/juhee/thesis/robosuite/robosuite/demos/output_demo_passive_viewer/captured_images_{datetime.today().strftime("%Y%m%d-%H%M%S")}_PickPlace'
os.makedirs(save_dir, exist_ok=True)

# Reset the environment
env.reset()
    
for i in range(3):  # Capture 1 frames
    # # Throw away the first five frames
    # if i < 5: continue
